# archiver [![archiver GoDoc](https://img.shields.io/badge/reference-godoc-blue.svg?style=flat-square)](https://pkg.go.dev/github.com/alauda/archiver/v3) [![Ubuntu-latest](https://github.com/alauda/archiver/actions/workflows/ubuntu-latest.yml/badge.svg)](https://github.com/alauda/archiver/actions/workflows/ubuntu-latest.yml) [![Macos-latest](https://github.com/alauda/archiver/actions/workflows/macos-latest.yml/badge.svg)](https://github.com/alauda/archiver/actions/workflows/macos-latest.yml) [![Windows-latest](https://github.com/alauda/archiver/actions/workflows/windows-latest.yml/badge.svg)](https://github.com/alauda/archiver/actions/workflows/windows-latest.yml)
...
See <https://pkg.go.dev/github.com/alauda/archiver/v3>
...
```bash
go install github.com/alauda/archiver/v3/cmd/arc@latest
```
...
1. Download the binary for your platform from the [Github Releases](https://github.com/alauda/archiver/releases) page.
...
```bash
go get github.com/alauda/archiver/v3
```

```go
import "github.com/alauda/archiver/v3"
```

[See the package's GoDoc](https://pkg.go.dev/github.com/alauda/archiver/v3) for full API documentation.
...
The archive format is determined by file extension. (There are [several functions in this package](https://pkg.go.dev/github.com/alauda/archiver/v3) which perform a task by inferring the format from file extension or file header, including `Archive()`, `Unarchive()`, `CompressFile()`, and `DecompressFile()`.)
...
There's a lot more that can be done, too. [See the GoDoc](https://pkg.go.dev/github.com/alauda/archiver/v3) for full API documentation.
